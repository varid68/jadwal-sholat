 ...
 */
var PopupModalPage = (function () {
    function PopupModalPage(navCtrl, navParams, viewCtrl) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.viewCtrl = viewCtrl;
    }
    PopupModalPage.prototype.ionViewWillEnter = function () {
        this.id = this.navParams.get('id');
    };
    PopupModalPage.prototype.dismiss = function () {
